    ...
    extends TitleAreaDialog
{
    ...
    public PushDialog4(Shell parentShell)
    {
        super(parentShell);
    }
    ...
    public void create()
    {
        // Генерируем instructionText через GitUtil (null для active window)
        instructionText = GitUtil.getInstructionFromGit(null);
        super.create();
        setTitle("Отправка коммита"); //$NON-NLS-1$
        // setMessage не используем, добавим custom Text
    }
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        // Read-only Text для instructionText (selectable, copyable, multi-line)
        ...
        instructionData.heightHint = computeTextHeightHint(2); // Меньше, т.к. текст упрощён
        ...
        // Опционально: моноширинный шрифт для Git-like вида
        // instructionTextWidget.setFont(JFaceResources.getFont(JFaceResources.TEXT_FONT));
        ...
        // Без Enter для OK — чтобы позволить новые строки
    ...
    protected void configureShell(Shell newShell)
    {
        ...
        newShell.setSize(400, 400); // Увеличено для текста
